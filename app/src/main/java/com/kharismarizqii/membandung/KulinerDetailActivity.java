...
public class KulinerDetailActivity extends AppCompatActivity {
    ...
    private void prepare(){
        tvName = (TextView)findViewById(R.id.tv_nama_kuliner);
        tvRating = (TextView)findViewById(R.id.tv_rating_kuliner);
        tvDesc = (TextView)findViewById(R.id.tv_desc_kuliner);
        ivPhoto = (ImageView)findViewById(R.id.iv_photo_kuliner);
        btnKunungi = (Button)findViewById(R.id.kunjungikuliner);
